...
exports.joinMonsterBatch = joinMonsterBatch;
...
var _batchPlanner = _interopRequireWildcard(require("./batch-planner"));
...
async function joinMonsterBatch(data, resolveInfo, context, dbCall, options = {}) {
  const sqlAST = queryAST.queryASTToSqlAST(resolveInfo, options, context);
  await (0, _batchPlanner.nextBatchChild)(sqlAST, data, dbCall, context, options);
  return data;
}
