...
function queryASTToSqlAST(resolveInfo, options, context) {
  ...
  _assert.default.ok(['table', 'union', 'delegated'].indexOf(sqlAST.type) > -1, 'Must call joinMonster in a resolver on a field where the type is decorated with "sqlTable".');
